...
// -elf, 切换用户时reset,更换sqlite数据库路径
+ (void)resetSQLiteInstance
{
    if (nil != sharedSQLiteManager)
    {
        [sharedSQLiteManager reset];
        
        [sharedSQLiteManager release];
...
- (NSString *)databaseFilepath
{
    // -Elf, add database filepath
//    if (nil != databaseFilepath)
//    {
//        return databaseFilepath;
//    }
//
//    NSString *dbPath = [JDUser currentUser].userDatabasePath;
//    if (nil != dbPath)
//    {
//        [databaseFilepath release];
//        databaseFilepath = [dbPath retain];
//        return databaseFilepath;
//    }
//#ifdef DEBUG
//    else 
//    {
//        [JDMessageView showWithSuperView:[UIApplication sharedApplication].keyWindow
//                                   title:@"SQLite Instance Manager"
//                                 message:@"JDUser.userDatabasePath == nil !!!"];
//    }
//#endif
